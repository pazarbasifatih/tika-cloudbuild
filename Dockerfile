...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install bash openjdk-14-jre-headless gdal-bin tesseract-ocr \
...
EXPOSE 9998
ENTRYPOINT ["java", "-jar", "/tika-server-1.24.1.jar", "-h", "0.0.0.0"]
